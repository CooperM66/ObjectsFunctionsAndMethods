...
#            The RoseWindow Render allows functions adn methods to show up in
# the window.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            it is used for convience, if it wasn't in then you'd have to
# manually close, but with that code implamented, it closes with a single
